...
def belief_state(bstate, summary_bstate, domain):
    ...
    """
    # YOUR CODE HERE
    data = bstate[domain]['semi']
    for slot in ['food', 'pricerange', 'name', 'area']:
        summary_bstate.append(data[slot] == 'not mentioned')
        summary_bstate.append(data[slot] in ['dont care', "don't care"])
        summary_bstate.append(data[slot] not in ['not mentioned', "don't care", 'dont care'])
    # YOUR CODE ENDS HERE
...
def requested_state(bstate, summary_bstate, domain):
    ...
    for slot in [
        ...
        # YOUR CODE HERE
        summary_bstate.append(slot in bstate[domain]['semi']['requested'])
        # YOUR CODE ENDS HERE
    return summary_bstate
